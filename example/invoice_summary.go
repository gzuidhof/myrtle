...
func InvoiceSummaryEmailWithTheme(selectedTheme theme.Theme) (*myrtle.Email, error) {
	...
	return myrtle.NewBuilder(
		...
		AddHeading("Usage details", myrtle.HeadingLevel(3)).
		AddTable(
		...
		AddButton("Download invoice", "https://example.com/billing/invoices/inv-0242", myrtle.ButtonTone(myrtle.ToneSecondary), myrtle.ButtonFullWidth(true)).
		AddFooterLinks(
